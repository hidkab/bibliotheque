...
INSERT INTO `User` (lastname, firstname, phone, email, sex, password, birth_date, city, city_code, street_number, street)
VALUES
...
INSERT INTO Book (title, author, categoty, date_of_onset, abstract, user_id)
VALUES
...
-- ("Thermodynamique Matériaux PC", "Jacques MESPLEDE", "Science", "2004/01/01", "Cours Méthodes Exercices résolus", 1);
